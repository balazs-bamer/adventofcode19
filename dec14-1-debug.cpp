...
components.print("branch: ");
  ...
  void print(char prefix[]) {
    ...
    for(auto &i : mComponents) {
      std::cout << '<'<<i.quantity << ' ' << i.material << "> ";
    }
    std::cout << '\n';
  }
};
...
for(auto &i : mPossibleReactions) {
  std::cout << i.first.quantity << ' ' << i.first.material;
  i.second.print(" = ");
}
  }
  ...
  size_t findCheapest() {
    ...
    gatherTargets();
std::cout << "\n";
for(auto &i : mReactionsInProgress) {
  i.print("t: ");
}
std::cout << "\n";
